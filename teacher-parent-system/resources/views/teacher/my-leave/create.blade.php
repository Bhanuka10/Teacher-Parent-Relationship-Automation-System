...
<div class="max-w-7xl">
    ...
    <div class="content-grid">
        <form method="POST" action="{{ route('teacher.my-leave.store') }}" class="space-y-5" id="leave-form">
            @csrf
        ...
        <div class="section-card">
            ...
            <div class="tips-box">
                Tip: you'll be notified once the admin reviews this request. Pending requests can still be edited or cancelled from the my leave page.
            </div>
        </div>
    </div>
</div>
