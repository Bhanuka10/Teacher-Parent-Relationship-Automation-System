...
<div class="mx-auto max-w-2xl">
    ...
    <form method="POST" action="{{ route('teacher.my-leave.store') }}" class="mt-6">
        ...
        <button type="submit" class="ui-submit-btn mt-5 w-full justify-center" style="width:100%;background:linear-gradient(135deg,#0f766e,#14b8a6)">Submit request</button>
    </form>
</div>
@endsection
