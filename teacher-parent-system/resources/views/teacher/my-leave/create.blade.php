...
<div class="mx-auto max-w-2xl">
    ...
    <p class="mt-1 text-sm text-gray-500">Submit a date range and reason — the admin will review it.</p>
    ...
    <form method="POST" action="{{ route('teacher.my-leave.store') }}" class="mt-6">
        ...
        <button type="submit" class="ui-submit-btn mt-5 w-full justify-center" style="width:100%">Submit request</button>
    </form>
</div>
@endsection
